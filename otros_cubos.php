...
<?php
 ...
 $sentencia= $db->query("SELECT * FROM productos WHERE tipo='otro'");

 $otros = $sentencia->fetchAll();
...
<body>
    <div class="contenedor">
        ...
        <section class="main">
        <h1>Otros Cubos Rubik</h1>
        <?php foreach ($otros as $n){ ?>
        <div class="prod">
